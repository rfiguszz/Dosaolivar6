...
namespace SmartHotel.Clients.Core.Services.Request
{
    public class RequestService : IRequestService
    {
        ...
        {
            Console.WriteLine("Task < TResult > PostAsync");
            //var httpClient = CreateHttpClient(token);
        ...
        public Task<TResult> DeleteAsync<TResult>(string uri, TResult data, string token = "") => DeleteAsync<TResult, TResult>(uri, data, token);
