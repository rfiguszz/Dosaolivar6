...
namespace SmartHotel.Clients.Core.ViewModels
{
    ...
    public class DetalleListaEquipoViewModel : ViewModelBase
    {
        ...
        //-------   INIT 
        public DetalleListaEquipoViewModel(
        ...
        {
            Console.WriteLine("DetalleListaEquipoViewModel ASYNC");
            ...
            if (navigationData != null)
            {
                ...
                equipo = navigationData as EquipoModel;
                Console.WriteLine("Se carga DetalleListaEquipoViewModel con datos: " + Equipo.boquilla1id);
        ...
        private void getListaBoquillasDiscos()
        {
            ...
            {
                boquillas.Add(new EquipoBoquillasDiscosModel { des = equipo.boquilla1des, url = equipo.boquilla1url, cantidad = equipo.boquilla1cantidad, pos = "1" });
            }
            if (equipo.boquilla2id != null)
            {
                boquillas.Add(new EquipoBoquillasDiscosModel { des = equipo.boquilla2des, url = equipo.boquilla2url, cantidad = equipo.boquilla2cantidad, pos = "2" });
            }
            if (equipo.boquilla3id != null)
            {
                boquillas.Add(new EquipoBoquillasDiscosModel { des = equipo.boquilla2des, url = equipo.boquilla2url, cantidad = equipo.boquilla2cantidad, pos = "3" });
            }
        }
